...
To perform random walk on a document set, such as Nordjyske, probabilities of jumping between documents is needed to perform each step. \todo[inline]{say why this is usefull}.
...
\section{Similarity Measures}\label{sec:similarity} \todo[inline]{how about comparison against basics - tf-idf}
\subsection{Similarity between two documents}\todo[inline]{too many subsections with very little text}
