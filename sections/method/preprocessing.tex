...
\todo[inline]{make running example, also mention only keeping words consisting of only normal letters}
32201
...
Construct and save \texttt{scikit-learn.CountVectorizer} as a \texttt{sparse.csr\_matrix} \texttt{npz} file, and word2vec, doc2vec, doc2word as \texttt{csv} files.\vejleder[inline]{what is the structure of the csv files and why do we create them?}
\todo[inline]{make running example}
