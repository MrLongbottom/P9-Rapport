...
\todo[inline]{mention how our pagerank in praxis is already combined with lda, since it is based on topics. perhaps also in dicussion/conclusion to give lda some more credit.}
...
\gls{pr} does not take the query into account, which is the reason it is not used stand-alone. 
