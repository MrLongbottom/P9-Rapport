...
\begin{figure}[h]
	...
	\caption{Plate notation for \gls{lda}. Boxes symbolize repeated processes, shaded elements are observed information. Source: \url{https://en.wikipedia.org/wiki/Latent_Dirichlet_allocation}}
	\label{fig:lda}
\end{figure}
...
We use the \texttt{gensim}\footnote{\url{https://radimrehurek.com/gensim/models/ldamodel.html}} implementation of \gls{lda}, which is based on online \gls{lda} by  \citeauthor{online}\cite{online} which uses stochastic optimization.
This has shown to work better on large datasets than batch based algorithms \cite{online}.
