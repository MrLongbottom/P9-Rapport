...
\begin{figure}[h]
	...
	\caption{Plate notation for \gls{lda}. Boxes symbolize repeated processes, shaded elements are observed information\cite{blei2012topicmodels}.}
	\label{fig:lda}
\end{figure}
\vejleder[inline]{beskriv hver plate i LDA}
