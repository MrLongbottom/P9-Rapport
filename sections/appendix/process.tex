...
Importantly we also implemented thresholds to the topic-document distributions matrix $\theta$ and  the topic-word distributions matrix $\beta$ made by the \gls{lda} model.
