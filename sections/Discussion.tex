...
This is worth noting as our adjacency matrix was constructed based on similarity of the documents' topic-distributions, rather than any relation embedded in the documents themselves, such as scientific articles referencing each other as with \cite{yang2009topic}.
...
They use the standard \gls{pr} in $\frac{4}{13}$ test cases, where we use \gls{pr} in $\frac{12}{18}$ test cases.
