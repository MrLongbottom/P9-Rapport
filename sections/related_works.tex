...
While our method in some ways will be similar to the work of \citeauthor{Tang2008} and \citeauthor{yang2009topic}, our method will have a significant change of working since we use a different data set without explicit edges and the data set is also from a different literature area, namely news articles.
