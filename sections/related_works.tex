...
This model is used widely within the field of topic modeling and is somewhat considered a standard.\todo[inline]{ref to lda section for more detail.}
...
This random walk model has a modified transition probability based on sentence-topic similarity and topic-document similarity.\todo[inline]{Vi skal overveje om brugen af "topic" her kan forvirre, da de topics der kommer fra cluster artiklen er anderledes fra lda topics.}
