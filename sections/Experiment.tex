...
This makes them had to compare on a single baseline, however it is still possible to compare these two results between multiple baselines.

For evaluation metrics/measures we use \gls{map} and .
