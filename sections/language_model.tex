...
$ \frac{tf(w,d)}{N_d} $ is the maximum likelihood estimate based on the relative counts.
\todo{ref equation} calculates the relative maximum likelihood for the word being in $ d $ and $ D $ and weights these terms based on the document length compared to $\lambda$, with smaller documents weighing the corpus likelihood higher, and bigger documents weighing the document likelihood higher.
