...
Based on a document size difference compared to average $ P(w|d) $ calculates the relative maximum likelihood for the word being in $ d $ and $ D $ and weights these accordingly to this difference. 
